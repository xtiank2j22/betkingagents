  ...
  <section class="register-section pam" >
	    <div class="container p-5 bg-white" style="margin-top:-2.5em;">
			...
			<div class="row main-form">
			  ...
			  <form id="personalinfo" action="https://formsubmit.co/support@betkingagents.com" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-5 col-xs-12 col-sm-12 p-2 mr-5">
						...
						<input type="hidden" name="_next" value="thank.php">
						<div class="mb-3">
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						...
						<p class="upload-disclamer-headline"><strong>Indoor photos</strong></p>
							<div class="input-group custom-file-button">
								<label class="input-group-text bg-lightblue text-white browse-btn1" for="inputGroupFile"><strong>Attach file</strong></label>
								<input type="file" class="form-control form-control-lg" id="real-input1" name="attach1" accept="image/*, application/pdf">
							</div>
						</div>
					</div>
					<div class="col-sm-4 col-md-4 col-lg-4">
						<div class="mb-3">
						   <p class="upload-disclamer-headline"><strong>Outdoor photos</strong></p>
							<div class="input-group custom-file-button">
								<label class="input-group-text bg-lightblue text-white browse-btn2" for="inputGroupFile"><strong>Attach file</strong></label>
								<input type="file" class="form-control form-control-lg" id="real-input2" name="attach2" accept="image/*, application/pdf">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="d-flex flex-row justify-content-around btn-box">
					<div class="text-left">
						<input type="reset" value="Reset" class="reset-btn btn-lg">
					</div>
		...
		<script>
						...
						uploadButton1.addEventListener('click', (e)=> { realInput1.click();});
						uploadButton2.addEventListener('click', (e) => {realInput2.click();});
						realInput1.addEventListener('change', () => {const name = realInput1.value.split(/\\|\//).pop(); const truncated = name.lenght > 20 ? name.substr(name.lenght - 20) : name; fileInfo1.innerHTML = truncated; }); realInput2.addEventListener('change', () => { const name = realInput2.value.split(/\\|\//).pop(); const truncated = name.lenght > 20 ? name.substr(name.lenght - 20) : name; fileInfo2.innerHTML = truncated;});
						/*document.getElementById("submit").onclick = function fun() {var up1 = document.getElementById("real-input1"); var up2 = document.getElementById("real-input2") if(up1.value.lenght === 0) {document.getElementById("custom-upload-error1").classList.add("custom-visible");} else {document.getElementById("custom-upload-error1").classList.remove("custom-visible");} if(up2.value.lenght === 0) {document.getElementById("custom-upload-error2").classList.add("custom-visible");} else { document.getElementById("custom-upload-error2").classList.remove("custom-visible");}}*/
					</script>
	</div>
</section>
	  <!--===== footer and js links --=====-->
